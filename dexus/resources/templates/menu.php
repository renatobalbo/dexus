...
<div class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo $currentPage === 'servicos' ? 'active' : ''; ?>" href="?page=servicos">
                    <i class="fas fa-cogs me-2"></i>
                    Serviços
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo $currentPage === 'modalidades' ? 'active' : ''; ?>" href="?page=modalidades">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo $currentPage === 'os' ? 'active' : ''; ?>" href="?page=os">
