...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('form-modalidade').addEventListener('submit', function(e) {
            ...
            if (document.getElementById('MODDES').classList.contains('is-invalid')) {
                formValido = false;
                if (!campoComErro) campoComErro = document.getElementById('MODDES');
            }
            ...
            // Exibir loader
            const loaderModal = showLoader('Salvando modalidade...');
        ...
        document.getElementById('MODDES').addEventListener('blur', function() {
            ...
            fetch(`api.php?action=verificar_modalidade_descricao&descricao=${encodeURIComponent(descricao)}`)
                .then(response => response.json())
                .then(data => {
                    if (data.exists) {
                        alert('ATENÇÃO: Já existe uma modalidade cadastrada com esta descrição! Por favor, informe outra descrição para continuar.');
        ...
        document.getElementById('MODDES').addEventListener('input', function() {
            const btnSalvar = document.querySelector('button[type="submit"]');
            // Remover classe de erro
            this.classList.remove('is-invalid');
            // Remover mensagem de erro
