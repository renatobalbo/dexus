        ...
        document.getElementById('CLIDOC').addEventListener('blur', function() {
            ...
            if (docValido) {
                ...
                fetch(`api.php?action=verificar_documento&doc=${docLimpo}`)
                    ...
                    .then(data => {
                        if (data.exists) {
                            alert('ATENÇÃO: Já existe um cliente cadastrado com este CPF/CNPJ!');
                ...
                if (tipo === 'J') {
                    ...
                    fetch(`https://brasilapi.com.br/api/cnpj/v1/${docLimpo}`)
                        ...
                        .then(data => {
                            ...
                            document.getElementById('CLIRAZ').value = data.razao_social.substring(0, 80);
                            document.getElementById('CLIFAN').value = data.nome_fantasia.substring(0, 40);
